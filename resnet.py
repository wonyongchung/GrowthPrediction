...
class BasicBlock1d(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.conv1 = nn.Conv2d(inplanes, planes, kernel_size=7, stride=stride, padding=3, bias=False)
...
class ResNet1d(nn.Module):
    def __init__(self, block, layers, input_channels=3, inplanes=64):
        super(ResNet1d, self).__init__()
        self.inplanes = inplanes
        self.conv1 = nn.Conv2d(input_channels, self.inplanes, kernel_size=15, stride=2, padding=7, bias=False)
        ...
        self.fc = nn.Linear(512 * block.expansion * 2, 1)
